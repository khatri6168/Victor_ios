...
//  Deonde
//
//  Created by Ankit Rupapara  on 22/04/20.
...
class CountryCode
{
    ...
    func all() -> [CountryCode]{
        ...
        let bundle = Bundle(for: CountryCodeViewController.self)
