...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MMLoadingButton/MMLoadingButton.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RHPlaceholder/RHPlaceholder.framework"
